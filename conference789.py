...
class ConferenceApp:
    ...
    def create_middle_buttons(self, parent):
        ...
        tk.Button(middle_frame, text="進入計時會議", width=12, command=self.go_to_conference_page).pack(side="left", padx=10)
        tk.Button(middle_frame, text="進入FIFO會議", width=12, command=self.go_to_fifoconference_page).pack(side="left", padx=10)
        tk.Button(middle_frame, text="離開", width=12, command=self.close_window).pack(side="left", padx=10)
